import BannerImg from '../../assets/image/women2-wroTMLvf.jpg';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                    ...
                    <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                        ...
                        <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>
                            ...
                            Culpa aut ratione possimus rem architecto! Esse,
                            hic! Incidunt debitis optio expedita.
                        </p>
                        <div className='flex flex-col gap-4'>
                            ...
                            <div data-aos="fade-up" className='flex items-center gap-4'>
                                <FaGift className='text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-violet-100 dark:bg-violet-400' />
                                <p>Get Offers</p>
                            </div>
                        </div>
                    </div>
