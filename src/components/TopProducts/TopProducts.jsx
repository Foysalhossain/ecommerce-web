import Img1 from "../../assets/image/shirt1.png";
import Img2 from "../../assets/image/shirt2.png";
import Img3 from "../../assets/image/shirt3.png";
...
const ProductsData = [
    {
        ...
        img: Img1,
        title: "Casual Wear",
        descripton: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem, mollitia consequuntur illo dicta commodi quibusdam. Sed obcaecati temporibus fugiat placeat.",
    },
    {
        id: 2,
        img: Img2,
                            ...
                            >
                                ...
                                <div className="h-[100px]">
                                    <img src={data.img} alt=""
                                        className="max-w-[140px] blcok mx-auto 
                                ...
                                <div className="p-4 text-center">
                                    ...
                                    <p className="text-gray-500 group-hover:white duration-300 text-sm line-clamp-2">{data.descripton}</p>
