...
import image2 from '../../assets/image/shopping.png';
import image3 from '../../assets/image/sale.png';
...
const ImageList = [
    {
        ...
        description:
            "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus doloribus, quibusdam laborum repellendus perferendis atque similique soluta quasi nulla numquam. Optio soluta delectus reiciendis architecto accusantium itaque id necessitatibus molestias."
    },
    {
        id: 2,
        img: image2,
...
const Hero = ({ handleOrderPopup }) => {
    ...
    return (
        <div className='relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 flex justify-center items-center
         dark:bg-gray-950 dark:text-white duraiton-200'>
            {/* background pattern */}
